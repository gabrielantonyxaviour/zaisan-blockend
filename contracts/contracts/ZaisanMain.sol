...
contract ZaisanMain is ReentrancyGuard, SismoConnect {
    ...
    function createPromotion(
        ...
        igp.payForGas{value: quotedPayment}(
            IMailbox(chains[promotionParams.destinationDomain].mailboxAddress)
                .dispatch(
                    promotionParams.destinationDomain,
        ...
        promotions[_promotionId] = Promotion(
            _getAddress(
                ...
                promotionParams.badgeURI,
                msg.sender,
                chains[promotionParams.destinationDomain].mailboxAddress,
    ...
    function claimPromotion(
        ...
        bytes32 _messageId = IMailbox(
            chains[_promotion.destinationDomain].mailboxAddress
        ).dispatch(
    ...
    function _getAddress(
        ...
        bytes memory bytecode = abi.encodePacked(
            ...
            abi.encode(badgeURI, msg.sender, creator, _mailbox)
        );
