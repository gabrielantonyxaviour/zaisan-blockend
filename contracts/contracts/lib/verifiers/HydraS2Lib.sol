...
library HydraS2Lib {
    ...
    function _input(HydraS2ProofData memory self)
        internal
        pure
        returns (HydraS2ProofInput memory)
    {
        return
            HydraS2ProofInput(
    ...
    function _toCircomFormat(HydraS2ProofData memory self)
        internal
        pure
        returns (
            uint256[2] memory,
    ...
    function _getDestinationIdentifier(HydraS2ProofData memory self)
        internal
        pure
        returns (address)
    {
    ...
    function _getExtraData(HydraS2ProofData memory self)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getCommitmentMapperPubKey(HydraS2ProofData memory self)
        internal
        pure
    ...
    function _getRegistryRoot(HydraS2ProofData memory self)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getRequestIdentifier(HydraS2ProofData memory self)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getProofIdentifier(HydraS2ProofData memory self)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getClaimValue(HydraS2ProofData memory self)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getAccountsTreeValue(HydraS2ProofData memory self)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getClaimComparator(HydraS2ProofData memory self)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getVaultIdentifier(HydraS2ProofData memory self)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getVaultNamespace(HydraS2ProofData memory self)
        internal
        pure
        returns (uint256)
    {
    ...
    function _getSourceVerificationEnabled(HydraS2ProofData memory self)
        internal
        pure
        returns (bool)
    {
    ...
    function _getDestinationVerificationEnabled(HydraS2ProofData memory self)
        internal
        pure
        returns (bool)
    {
