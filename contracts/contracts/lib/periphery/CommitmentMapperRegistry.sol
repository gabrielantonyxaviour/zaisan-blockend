 ...
 *
 */
contract CommitmentMapperRegistry is
    ICommitmentMapperRegistry,
    Initializable,
    Ownable
{
     ...
     */
    function updateCommitmentMapperEdDSAPubKey(uint256[2] memory newEdDSAPubKey)
        external
        onlyOwner
    {
    ...
    function _updateCommitmentMapperEdDSAPubKey(uint256[2] memory pubKey)
        internal
    {
