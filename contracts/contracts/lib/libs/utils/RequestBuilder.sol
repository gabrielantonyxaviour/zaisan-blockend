...
library RequestBuilder {
    ...
    function buildRequestContent(
        ...
        return
            buildRequestContent(
                GET_DEFAULT_CLAIM_REQUEST(),
                authRequest,
                messageSignatureRequest
            );
    }

    function buildRequestContent(Claim memory claimRequest)
        public
    ...
    function buildRequestContent(Auth memory authRequest)
        public
        returns (ZkConnectRequestContent memory)
    {
    ...
    function buildRequest(Claim memory claimRequest, bytes16 appId)
        public
    ...
    function buildRequest(Auth memory authRequest, bytes16 appId)
        public
        returns (ZkConnectRequest memory)
    {
        return (
