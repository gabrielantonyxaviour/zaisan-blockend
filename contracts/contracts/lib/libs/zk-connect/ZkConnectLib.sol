...
contract ZkConnect is IZkConnectLib, Context {
    ...
    function verify(bytes memory responseBytes, Auth memory authRequest)
        internal
    ...
    function verify(bytes memory responseBytes, Claim memory claimRequest)
        internal
        returns (ZkConnectVerifiedResult memory)
    {
        ZkConnectResponse memory zkConnectResponse = abi.decode(
    ...
    function buildClaim(bytes16 groupId, uint256 value)
        internal
        pure
        returns (Claim memory)
    {
    ...
    function buildAuth(AuthType authType, bool anonMode)
        internal
        pure
        returns (Auth memory)
    {
    ...
    function buildAuth(AuthType authType, uint256 userId)
        internal
        pure
        returns (Auth memory)
    {
    ...
    function buildRequest(Claim memory claimRequest, Auth memory authRequest)
        internal
        returns (ZkConnectRequest memory)
    {
    ...
    function buildRequest(Claim memory claimRequest)
        internal
        returns (ZkConnectRequest memory)
    {
    ...
    function buildRequest(Auth memory authRequest)
        internal
        returns (ZkConnectRequest memory)
    {
    ...
    function buildRequest(Claim memory claimRequest, bytes16 namespace)
        internal
        returns (ZkConnectRequest memory)
    {
    ...
    function buildRequest(Auth memory authRequest, bytes16 namespace)
        internal
        returns (ZkConnectRequest memory)
    {
