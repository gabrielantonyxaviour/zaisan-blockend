...
export function createNewChainAddedEvent(
  destinationDomain: BigInt
): NewChainAdded {
  let newChainAddedEvent = changetype<NewChainAdded>(newMockEvent())

  newChainAddedEvent.parameters = new Array()

  newChainAddedEvent.parameters.push(
    new ethereum.EventParam(
      "destinationDomain",
